...
<p><b>Address:</b>
 ...
 <form name="myform" form action="bookroom.jsp">
     <input type="submit" name="button" onclick="document.pressed=this.value" value="next">
 </form>
...
function OnSubmitForm()
{
  ...
  {
   document.myform.action ="bookroom.jsp";
  } 
  }
