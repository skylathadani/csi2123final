...
<h1>Please enter customer information below</h1>
...
SIN written like (111222333): <input type="text" name="sin" />
phone written like (1231231234): <input type="text" name="phone" />
